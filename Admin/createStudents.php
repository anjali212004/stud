...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"select * from tblstudents where Enrollment_no ='$Enrollment_no'");
    $ret=mysqli_fetch_array($query);

    if($ret > 0){ 

        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>This enrollment no already exists</div>";
    }
    else{

    $query=mysqli_query($conn,"insert into tblstudents(firstName,lastName,Enrollment_no,password,classId,classArmId,dateCreated) 
    value('$firstName','$lastName','$Enrollment_no','12345','$classId','$classArmId','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set firstName='$firstName', lastName='$lastName', Enrollment_no='$Enrollment_no',password='12345', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
            if ($query) {
                  ...
                  <form method="post">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Enrollment_no<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" required name="Enrollment_no" value="<?php echo $row['Enrollment_no'];?>" id="exampleInputFirstName" >
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
